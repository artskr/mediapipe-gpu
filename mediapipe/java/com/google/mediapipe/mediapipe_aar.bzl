...
""",
    ...
    android_library(
        ...
        deps = [
            ...
            "//third_party_mp:androidx_annotation",
            "//third_party_mp:androidx_appcompat",
            "//third_party_mp:androidx_core",
            "//third_party_mp:androidx_legacy_support_v4",
            "//third_party_mp:autovalue",
            "//third_party_mp:camerax_core",
            "//third_party_mp:camerax_camera2",
            "//third_party_mp:camerax_lifecycle",
